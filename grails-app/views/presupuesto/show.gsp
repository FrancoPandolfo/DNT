...
<html>
    ...
    <body>
        ...
        <div id="show-presupuesto" class="content scaffold-show" role="main">
            ...
            <f:display bean="presupuesto" />
            <g:form resource="${this.presupuesto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.presupuesto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
