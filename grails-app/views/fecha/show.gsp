...
<html>
    ...
    <body>
        ...
        <div id="show-fecha" class="content scaffold-show" role="main">
            ...
            <f:display bean="fecha" />
            <g:form resource="${this.fecha}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.fecha}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
